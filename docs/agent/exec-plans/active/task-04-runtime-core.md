...
- Next action: preserve Task 4 runtime closeout, keep Task 5b queued until the team explicitly starts the emulator bridge, and hand off final acceptance through Task 6.
...
Task 5 replaces the former emulator-bridge numbering. Task 5a is complete as the bridge-readiness checklist, and Task 5b remains queued until the team explicitly starts the emulator bridge.
...
2. Keep Task 5b queued after the Task 5a readiness closeout until the team explicitly starts the emulator bridge.
