...
| Task 5 | `docs/agent/exec-plans/active/task-05-emulator-stremio-web-smoke-validation.md` | active | Codex | Task 5b is blocked until the bridge reaches `https://web.stremio.com/` with provably fresh live runtime code |
