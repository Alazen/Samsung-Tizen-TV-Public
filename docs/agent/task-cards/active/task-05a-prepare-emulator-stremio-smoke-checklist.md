# TaskCard: Task 5a, Prepare Emulator Stremio Smoke Checklist
...
Prepare the canonical smoke checklist that will be used to validate `https://web.stremio.com/` in the Samsung TV emulator after Task 4 local validation passes and Task 5 is explicitly started.
